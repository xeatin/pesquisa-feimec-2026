...
- URL de busca FEIMEC: https://app.informamarkets.com.br/event/feimec-2026/exhibitors/RXZlbnRWaWV3XzEyMTA2ODM=?search=NASCHOLD
- Correspondências encontradas: 1

## O que a empresa faz em 80/20
NASCHOLD atua com insumos e componentes críticos para manter a produção industrial abastecida, estável e com desempenho técnico adequado. Em termos práticos, sua oferta gira em torno de Aços, ligas e metais, Fixadores e componentes, Abrasivos e consumíveis. O valor central para o cliente está em garantir disponibilidade, elevar desempenho do processo, reduzir custo e variabilidade de suprimento.
...
A NEF (Naschold Elementos de Fixação Ind e Com Ltda) foi fundada em agosto de 1980. Inicialmente com sede em Itapecerica da Serra e a partir de 2003, em Capela do Alto grande região de Sorocaba no interior de São Paulo. Contando com espaço físico de aproximadamente 6.000m².
