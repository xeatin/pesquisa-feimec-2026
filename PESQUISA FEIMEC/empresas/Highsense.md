...
- URL de busca FEIMEC: https://app.informamarkets.com.br/event/feimec-2026/exhibitors/RXZlbnRWaWV3XzEyMTA2ODM=?search=Highsense
- Correspondências encontradas: 1

## O que a empresa faz em 80/20
Highsense atua em automação e robótica para tornar operações industriais mais produtivas, flexíveis, seguras e repetíveis. Em termos práticos, sua oferta gira em torno de Robôs industriais e colaborativos, Sistemas de automação, Controladores e drives. O valor central para o cliente está em aumentar produtividade, melhorar flexibilidade operacional, reduzir risco e variabilidade.
...
Somos especializados em soluções de controle de movimento de alta precisão. Oferecemos principalmente servodrives com os protocolos Modbus, EtherCAT e Profinet. Nossas principais linhas de produtos incluem servodrives de alta tensão universais, servodrives de alta tensão multi-eixo, servodrives de baixa tensão multi-eixo, servodrives para motores lineares, unidades de acionamento e controle integradas, e sistemas de articulação para robôs corporais.
