...
é um fornecedor global de automação de soldagem e produção. Somos especializados em projetar e fabricar sistemas inovadores de automação para indústria metalúrgica pesada. Nossas soluções são baseadas em tecnologia avançada de robô e automação.
