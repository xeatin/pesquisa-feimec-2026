...
- URL de busca FEIMEC: https://app.informamarkets.com.br/event/feimec-2026/exhibitors/RXZlbnRWaWV3XzEyMTA2ODM=?search=Jinqi
- Correspondências encontradas: 1

## O que a empresa faz em 80/20
Jinqi atua com máquinas e células produtivas para usinagem, conformação, corte, dobra, injeção ou produção industrial pesada. Em termos práticos, sua oferta gira em torno de Soluções de soldagem, Centros de usinagem, Tornos CNC. O valor central para o cliente está em elevar capacidade produtiva, ganhar precisão e repetibilidade, reduzir custo por peça e lead time.
...
Dalian Jinqi Machinery Manufacturing Co., Ltda. é uma fornecedora especializada em máquinas-ferramenta e sistemas de automação. Com anos de experiência no fornecimento para fabricantes de renome mundial de máquinas-ferramenta, a empresa é especializada na produção de componentes estruturais metálicos de médio e grande porte, tais como colunas e bases para máquinas-ferramenta, pórticos (gantries), linhas de produção automatizadas, equipamentos para usinas nucleares, equipamentos ambientais, bancadas de testes para aviação, entre outros.
