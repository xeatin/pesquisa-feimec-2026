...
- URL de busca FEIMEC: https://app.informamarkets.com.br/event/feimec-2026/exhibitors/RXZlbnRWaWV3XzEyMTA2ODM=?search=LEAS
- Correspondências encontradas: 1

## O que a empresa faz em 80/20
LEAS atua em automação e robótica para tornar operações industriais mais produtivas, flexíveis, seguras e repetíveis. Em termos práticos, sua oferta gira em torno de Soluções de soldagem, Robôs industriais e colaborativos, Sistemas de automação. O valor central para o cliente está em aumentar produtividade, melhorar flexibilidade operacional, reduzir risco e variabilidade.
...
é uma empresa italiana especializada em automação industrial avançada, robótica e sistemas de soldagem. Com mais de 50 anos de experiência, projeta e fabrica soluções personalizadas turnkey, incluindo células robotizadas, linhas automatizadas e sistemas produtivos inteligentes. Seu portfólio atende diversos setores, oferecendo alta eficiência, flexibilidade e inovação.
