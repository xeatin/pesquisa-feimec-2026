...
A Erzinger é referência nacional no desenvolvimento e fabricação de sistemas completos para pré-tratamento de superfícies, pintura industrial e processos de secagem, incluindo tecnologias com tinta líquida, pintura eletrostática a pó e KTL (E-coat). Com mais de 45 anos de experiência, a empresa entrega soluções integradas “turn-key”, combinando engenharia própria, alto nível de automação e eficiência operacional para diversos segmentos industriais, como metal-mecânico, autopeças, moveleiro, plástico, eletroeletrônico e agroindustrial. Presente em todo o Brasil e com atuação internacional em mercados estratégicos na América Latina, Europa e Ásia, a Erzinger se destaca pela capacidade de executar projetos de alta complexidade com padrão global de qualidade.
