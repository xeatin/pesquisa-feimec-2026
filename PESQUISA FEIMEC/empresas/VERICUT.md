...
A CGTech foi fundada em 1988 com sede em Irvine, Califórnia, é especializada em tecnologia de software para verificação, otimização e análise de Comando Numérico (CN/CNC). Desde a fundação, nosso principal produto, o software VERICUT®, tornou-se o padrão da indústria. Com escritórios em todo o mundo, o software VERICUT é utilizado por empresas de todos os portes, universidades/escolas técnicas e órgãos do governo.
