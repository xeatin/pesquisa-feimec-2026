...
- URL de busca FEIMEC: https://app.informamarkets.com.br/event/feimec-2026/exhibitors/RXZlbnRWaWV3XzEyMTA2ODM=?search=Jinzhize
- Correspondências encontradas: 1

## O que a empresa faz em 80/20
Jinzhize atua com insumos e componentes críticos para manter a produção industrial abastecida, estável e com desempenho técnico adequado. Em termos práticos, sua oferta gira em torno de Aços, ligas e metais, Fixadores e componentes, Abrasivos e consumíveis. O valor central para o cliente está em garantir disponibilidade, elevar desempenho do processo, reduzir custo e variabilidade de suprimento.
...
Dongtai Jinzhize Metal Products Co., Ltd. is a dynamic, promising and diversified modern private enterprise. It specializes in the production of various metal products, including automotive thread inserts, aerospace wire thread inserts, self-tapping threaded inserts, three-hole thread inserts, self-tapping insert taps, key-locking thread inserts and other related products.
