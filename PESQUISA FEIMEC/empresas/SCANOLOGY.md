...
A SCANOLOGY é uma fornecedora global de soluções de medição 3D de nível industrial, especializada em pesquisa e desenvolvimento, fabricação e comercialização de scanners 3D de alta precisão e sistemas integrados.
