...
Renishaw é um grupo global de tecnologia de metrologia de alta precisão e de saúde. Projetamos, desenvolvemos e entregamos soluções e sistemas que fornecem precisão, controle e confiabilidade incomparáveis. Somos também um líder mundial no campo da manufatura aditiva (também chamada impressão 3D), no qual projeta e produz máquinas industriais para "Imprimir" peças a partir de pó metálico.
